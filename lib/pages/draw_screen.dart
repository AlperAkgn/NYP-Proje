...
import 'package:flutter_application_1/pages/kazananlar_page.dart';
...
class _DrawScreenState extends State<DrawScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Çekiliş Ekranı"),
      actions: [
        ElevatedButton(onPressed: (){
          showDialog(context: context, builder: (contex)=>AlertDialog(
            content: TextField(decoration:InputDecoration(label: Text("Çekiliş ön ayar adı giriniz")),),
            actions: [
              ElevatedButton(onPressed: (){
          ...
          children: [
                  ...
                  showDialog(context: context, builder: (context)=> AlertDialog(
                    content: TextField(
                      ...
                      decoration: InputDecoration(
                        label: Text("Kazanan sayısı girin"),), ), actions: [ElevatedButton(onPressed: (){
                          Random ran = Random();
                          ...
                          Navigator.pop(context);
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> KazananlarPage(kazananlar: kazananlar,))).then((_){
            ...
            Expanded(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i)=> ListTile(leading: Icon(Icons.person), title: Text(participants[i]),))),
          ],
        ),
      )
    );
